import { delayTimeBuffer } from "./delay-time-buffer"
import { fadeBuffer } from "./fade-buffer"
...
export class Voice {
  ...
  constructor(
    ...
    this.shiftDownBuffer = delayTimeBuffer(
      context,
      bufferTime,
      fadeTime,
      false
    )
    this.shiftUpBuffer = delayTimeBuffer(
      context,
      bufferTime,
      fadeTime,
      true
    ...
    const fb = fadeBuffer(context, bufferTime, fadeTime)
    fade1.buffer = fb
    fade2.buffer = fb
    fade1.loop = true
    fade2.loop = true
